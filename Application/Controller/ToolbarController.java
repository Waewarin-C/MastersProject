...
public class ToolbarController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        homeIconPath.setFill(Color.WHITE);
        ...
        calendarIconPath.setFill(Color.WHITE);
        ...
        addEventIconPath.setFill(Color.WHITE);
        ...
        categoriesIconPath.setFill(Color.WHITE);
        ...
        settingsIconPath.setFill(Color.WHITE);
